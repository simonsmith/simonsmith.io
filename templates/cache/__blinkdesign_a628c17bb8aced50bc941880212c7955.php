...
class __blinkdesign_a628c17bb8aced50bc941880212c7955 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        $buffer .= $indent . '    <h1 class="excerpt-hdr"><a href="';
        ...
        $buffer .= $indent . '    ';
        // 'has_date' section
        $buffer .= $this->sectionAd1a8df779bfbcfb019ccc9c4217c14b($context, $indent, $context->find('has_date'));
        $buffer .= "\n";
        $buffer .= $indent . '    ';
        // 'has_image' section
    ...
    private function sectionAd1a8df779bfbcfb019ccc9c4217c14b(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '<time class="excerpt-date" datetime="{{w3c_date}}">{{date}}</time>';
            ...
            foreach ($values as $value) {
                $context->push($value);
                $buffer .= '<time class="excerpt-date" datetime="';
