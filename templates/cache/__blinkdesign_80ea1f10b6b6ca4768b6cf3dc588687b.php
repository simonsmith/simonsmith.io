...
class __blinkdesign_80ea1f10b6b6ca4768b6cf3dc588687b extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'has_image' section
        $buffer .= $this->sectionF5fe7e82ba513f9e8c92d674dacceea1($context, $indent, $context->find('has_image'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function sectionF5fe7e82ba513f9e8c92d674dacceea1(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <a href="{{url}}" class="work-img work-img-mini img-border">{{{image}}}</a>
        ';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
                ->renderInternal($context, $indent);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= htmlspecialchars($value, ENT_COMPAT, 'UTF-8');
                $buffer .= '" class="work-img work-img-mini img-border">';
