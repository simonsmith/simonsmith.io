...
class __blinkdesign_230fa606374ada763548dcaa10198cab extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'has_image' section
        $buffer .= $this->section1029174ff7dd9bdd983e04eea791b076($context, $indent, $context->find('has_image'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function section1029174ff7dd9bdd983e04eea791b076(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <a href="{{url}}">{{{image}}}</a>
