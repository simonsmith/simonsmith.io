...
class __blinkdesign_ae7902aadfa835ea55116af2e99ea097 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= "\n";
        // 'has_image' section
        $buffer .= $this->sectionA925ce3f4b4089b173a85f0c52b98726($context, $indent, $context->find('has_image'));
        $buffer .= $indent . '    </div>';
        $buffer .= "\n";
    ...
    private function sectionA925ce3f4b4089b173a85f0c52b98726(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <a href="{{url}}" class="ajax">{{{image}}}</a>
        ';
            $buffer .= $this->mustache
                ->loadLambda((string) call_user_func($value, $source))
                ->renderInternal($context, $indent);
