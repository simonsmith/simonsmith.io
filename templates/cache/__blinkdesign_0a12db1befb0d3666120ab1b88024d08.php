...
class __blinkdesign_0a12db1befb0d3666120ab1b88024d08 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '', $escape = false)
    {
        ...
        $buffer .= $indent . '    ';
        // 'has_date' section
        $buffer .= $this->section90c3d6cd5fbfcc369fa22c6b8edea1b0($context, $indent, $context->find('has_date'));
        $buffer .= "\n";
        $buffer .= $indent . '    ';
        // 'has_image' section
        $buffer .= $this->sectionF27e9ec6d1a6b55931f4f47495fa0f07($context, $indent, $context->find('has_image'));
        $buffer .= "\n";
    ...
    private function sectionF27e9ec6d1a6b55931f4f47495fa0f07(Mustache_Context $context, $indent, $value) {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
