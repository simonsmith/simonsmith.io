define(['handlebars'], function(Handlebars) {
    ...
    Handlebars.registerPartial("excerpt", Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program3(depth0, data) {
            ...
            if (stack1 = helpers.w3c_date) {
                stack1 = stack1.call(depth0, {hash: {}, data: data});
            }
            else {
                stack1 = depth0.w3c_date;
                stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
            }
            buffer += escapeExpression(stack1)
                + "\">";
        ...
        if (stack1 = helpers.has_image) {
            stack1 = stack1.call(depth0, options);
        }
        else {
            stack1 = depth0.has_image;
            stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
        }
        if (!helpers.has_image) {
        ...
        if (stack1 = helpers.has_date) {
            stack1 = stack1.call(depth0, options);
        }
        else {
            stack1 = depth0.has_date;
            stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
        }
        if (!helpers.has_date) {
            stack1 = blockHelperMissing.call(depth0, stack1, options);
    ...
    Handlebars.registerPartial("tags", Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program1(depth0, data) {
            ...
            var buffer = "", stack1;
            buffer += "\n    <dd><a href=\"";
            if (stack1 = helpers.site_root) {
                stack1 = stack1.call(depth0, {hash: {}, data: data});
            }
            else {
                stack1 = depth0.site_root;
                stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
            }
            buffer += escapeExpression(stack1)
                + "/tag/";
        ...
        options = {hash: {}, inverse: self.noop, fn: self.program(1, program1, data), data: data};
        if (stack1 = helpers.post_tags) {
            stack1 = stack1.call(depth0, options);
        }
        else {
            stack1 = depth0.post_tags;
            stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
        }
        if (!helpers.post_tags) {
            stack1 = blockHelperMissing.call(depth0, stack1, options);
        }
        if (stack1 || stack1 === 0) {
            buffer += stack1;
    ...
    this["Handlebars"]["templates"]["home.mustache"] = Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        options = {hash: {}, inverse: self.noop, fn: self.program(1, program1, data), data: data};
        if (stack1 = helpers.blog_posts) {
            stack1 = stack1.call(depth0, options);
        }
        else {
            stack1 = depth0.blog_posts;
            stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
        }
        if (!helpers.blog_posts) {
            stack1 = blockHelperMissing.call(depth0, stack1, options);
        }
        if (stack1 || stack1 === 0) {
            buffer += stack1;
    ...
    this["Handlebars"]["templates"]["projects.mustache"] = Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        options = {hash: {}, inverse: self.noop, fn: self.program(1, program1, data), data: data};
        if (stack1 = helpers.project_items) {
            stack1 = stack1.call(depth0, options);
        }
        else {
            stack1 = depth0.project_items;
            stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1;
        }
        if (!helpers.project_items) {
            stack1 = blockHelperMissing.call(depth0, stack1, options);
        }
        if (stack1 || stack1 === 0) {
            buffer += stack1;
